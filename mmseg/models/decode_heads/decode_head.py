...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def losses(self, seg_logits, seg_label):
            ...
            for loss_decode in losses_decode:
                if loss_decode.loss_name not in loss:
                    ...
                    if loss_decode.loss_name == 'loss_ce':
                        ...
                        loss[loss_decode.loss_name] = loss_decode(esmap)
                else:
                    # print("in loss")
                    if loss_decode.loss_name == 'loss_ce':
                        loss[loss_decode.loss_name] += loss_decode(
        ...
        # print("seg_logit", seg_logits[0].shape)
        # print("seg_logit2", seg_logits[1].shape)
        # seg_logit = seg_logits[0]
        # esmap = seg_logits[1]
