...
class ParallelASPPModelNew(DepthwiseSeparableASPPHead):
    def __init__(self, **kwargs):
        super(ParallelASPPModelNew, self).__init__(**kwargs)
        ...
        self.fuse_layer_2 = nn.Conv2d(in_channels=self.channels+self.channels+self.c1_channels+self.c1_channels, out_channels=self.channels+self.c1_channels, kernel_size=1, stride=1, padding=0)
